 ...
 * Components:
 * - ReserveCardComponent: Displays individual reservation details.
 */

import { ref, onMounted } from 'vue';
import { useI18n } from 'vue-i18n';
import ReserveCardComponent from './reserve-card.component.vue';
import { ReservaApi } from '../infrastructure/reserve.api.js';
  ...
  <section aria-labelledby="my-reservations-title">
    ...
    <div class="p-grid" style="justify-content: center;">
      <div v-for="reserva in reservas" :key="reserva.id" class="p-col-12 p-md-6 p-lg-4" style="display: flex; justify-content: center;">
        <reserve-card-component :reserva="reserva" />
      </div>
    </div>
  </section>
</template>
